    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Edit Data Dusun</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('dusuns.update', $dusun->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3 col-lg-6">
                        <label for="nama_dusun" class="form-label">Nama Dusun <span class="text-danger">*</span></label>
                        <input type="text" name="nama_dusun" value="{{ $dusun->nama_dusun }}"
                    ...
                    <div class="mb-3 col-lg-6">
                        ...
                        <input type="text" name="nama_kadus" value="{{ $dusun->nama_kadus }}"
